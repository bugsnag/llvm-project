...
{ "asmparser", "LLVMAsmParserV1", true, {"binaryformat", "core", "support"} },
...
{ "binaryformat", "LLVMBinaryFormatV1", true, {"support"} },
{ "bitreader", "LLVMBitReaderV1", true, {"bitstreamreader", "core", "support"} },
{ "bitstreamreader", "LLVMBitstreamReaderV1", true, {"support"} },
...
{ "core", "LLVMCoreV1", true, {"binaryformat", "remarks", "support"} },
...
{ "debuginfocodeview", "LLVMDebugInfoCodeViewV1", true, {"support", "debuginfomsf"} },
{ "debuginfodwarf", "LLVMDebugInfoDWARFV1", true, {"binaryformat", "object", "mc", "support"} },
{ "debuginfogsym", "LLVMDebugInfoGSYM", true, {"mc", "object", "support", "debuginfodwarf"} },
{ "debuginfomsf", "LLVMDebugInfoMSFV1", true, {"support"} },
{ "debuginfopdb", "LLVMDebugInfoPDBV1", true, {"binaryformat", "object", "support", "debuginfocodeview", "debuginfomsf"} },
{ "demangle", "LLVMDemangleV1", true, {} },
...
{ "irreader", "LLVMIRReaderV1", true, {"asmparser", "bitreader", "core", "support"} },
...
{ "mc", "LLVMMCV1", true, {"support", "binaryformat", "debuginfocodeview"} },
...
{ "mcparser", "LLVMMCParserV1", true, {"mc", "support"} },
...
{ "object", "LLVMObjectV1", true, {"bitreader", "core", "mc", "binaryformat", "mcparser", "support", "textapi"} },
{ "objectyaml", "LLVMObjectYAML", true, {"binaryformat", "object", "support", "debuginfocodeview", "mc"} },
{ "option", "LLVMOptionV1", true, {"support"} },
...
{ "remarks", "LLVMRemarksV1", true, {"bitstreamreader", "support"} },
...
{ "support", "LLVMSupportV1", true, {"demangle"} },
{ "symbolize", "LLVMSymbolizeV1", true, {"debuginfodwarf", "debuginfopdb", "object", "support", "demangle"} },
{ "tablegen", "LLVMTableGenV1", true, {"support"} },
{ "target", "LLVMTarget", true, {"analysis", "core", "mc", "support"} },
{ "textapi", "LLVMTextAPIV1", true, {"support", "binaryformat"} },
